...
export const messages = {
  zh: {
    ...
    heroSub:
      "邮箱开通钱包，生成支付链接，客户用 USDC 直付到你的地址——简单如传统收款链接。",
    ctaStart: "免费体验收款",
    ctaContract: "查看合约",
    ...
    copied: "已复制",
    payConfirm:
      "我确认金额与收款地址无误。USDC 将直转至商户钱包，ArcPay 不经手资金。",
    payBtn: "连接钱包并支付",
    paying: "处理中...",
    success: "支付成功",
    paidPrefix: "已支付",
  ...
  en: {
    ...
    heroSub:
      "Sign in with email, create a payment link, get paid in USDC directly to your wallet—as simple as a normal payment link.",
    ...
    copied: "Copied",
    payConfirm:
      "I confirm the amount and recipient. USDC goes directly to the merchant wallet; ArcPay never holds funds.",
